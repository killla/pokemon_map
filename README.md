...
- Создайте базу данных командой `python manage.py migrate`
- Создайте администратора командой `python manage.py createsuperuser`
- Запустите сервер командой `python3 manage.py runserver`
- Перейдите в [админку](http://localhost:8000/admin/) создайте необходимые виды покемонов, а также сущности покемонов на карте.
- После этого можно зайти на [главную](http://localhost:8000/) страницу и пользоваться сайтом.
